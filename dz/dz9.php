...
if (($num / 1000) % 10 == 1) echo ' одна тысяча ';
...
if (($num / 10) % 10 !== 1) {
    ...
    elseif ($num % 10 == 5) echo ' пять долларов ';
    elseif ($num % 10 == 6) echo ' шесть долларов ';
    elseif ($num % 10 == 7) echo ' семь долларов ';
    elseif ($num % 10 == 8) echo ' восемь долларов ';
